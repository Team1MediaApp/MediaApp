...
//▽이름글자 수 제한을위해 몇글자 썼는지 표시하기
        val mypage10limittNameReader = binding.mypagediamodifyEditName// 이름을 쓰는칸인데, 10자제한해야해서 몇자까지 썼는지 읽어오기 위해 불렀다.
        val mypage10limitName = binding.mypagediamodifyTxtNamecount // 10자 제한을 표시하는 txt이다.
        ...
        val mypage20limitStatusReader = binding.mypagediamodifyEditStatus// 이름을 쓰는칸인데, 10자제한해야해서 몇자까지 썼는지 읽어오기 위해 불렀다.
        val mypage20limitStatus = binding.mypagediamodifyTxtStatuscount // 10자 제한을 표시하는 txt이다.
